...
public class Noise {
   ...
   private static Noise.Grad[] grad4 = new Noise.Grad[]{
      new Noise.Grad(0.0, 1.0, 1.0, 1.0),
      new Noise.Grad(0.0, 1.0, 1.0, -1.0),
      new Noise.Grad(0.0, 1.0, -1.0, 1.0),
      new Noise.Grad(0.0, 1.0, -1.0, -1.0),
      new Noise.Grad(0.0, -1.0, 1.0, 1.0),
      ...
      new Noise.Grad(0.0, -1.0, -1.0, 1.0),
      new Noise.Grad(0.0, -1.0, -1.0, -1.0),
      new Noise.Grad(1.0, 0.0, 1.0, 1.0),
      new Noise.Grad(1.0, 0.0, 1.0, -1.0),
      new Noise.Grad(1.0, 0.0, -1.0, 1.0),
      new Noise.Grad(1.0, 0.0, -1.0, -1.0),
      new Noise.Grad(-1.0, 0.0, 1.0, 1.0),
      ...
      new Noise.Grad(-1.0, 0.0, -1.0, 1.0),
      new Noise.Grad(-1.0, 0.0, -1.0, -1.0),
      new Noise.Grad(1.0, 1.0, 0.0, 1.0),
      new Noise.Grad(1.0, 1.0, 0.0, -1.0),
      new Noise.Grad(1.0, -1.0, 0.0, 1.0),
      new Noise.Grad(1.0, -1.0, 0.0, -1.0),
      new Noise.Grad(-1.0, 1.0, 0.0, 1.0),
      ...
      new Noise.Grad(-1.0, -1.0, 0.0, 1.0),
      new Noise.Grad(-1.0, -1.0, 0.0, -1.0),
      new Noise.Grad(1.0, 1.0, 1.0, 0.0),
      new Noise.Grad(1.0, 1.0, -1.0, 0.0),
      new Noise.Grad(1.0, -1.0, 1.0, 0.0),
      new Noise.Grad(1.0, -1.0, -1.0, 0.0),
      new Noise.Grad(-1.0, 1.0, 1.0, 0.0),
   ...
   private static double dot(Noise.Grad g, double x, double y) {
      return g.x * x + g.y * y;
   }
   ...
   private static double dot(Noise.Grad g, double x, double y, double z, double w) {
   ...
   public static double noise(double xin, double yin, double zin, int octaves) {
      ...
      for (int i = 0; i < octaves; i++) {
         double freqFactor = Math.pow(2.0, i);
         result += noise(xin * freqFactor, yin * freqFactor, zin) * Math.pow(1.0, -i);
      }
