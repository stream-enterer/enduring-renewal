...
public class ORRequirement implements ConditionalRequirement {
   final ConditionalRequirement a;
   final ConditionalRequirement b;

   public ORRequirement(ConditionalRequirement a, ConditionalRequirement b) {
      this.a = a;
      this.b = b;
   }
   ...
   public String describe(Eff eff) {
      return this.a.describe(eff) + " or " + this.b.describe(eff);
   }

   @Override
   public String getBasicString() {
      return this.a.getBasicString() + " or " + this.b.getBasicString();
   }
