...
public class StingProjectile extends SimpleAbstractProjectile {
   public StingProjectile(Ent source, Ent target, int damage) {
      super(source, target, damage, 0.2F);
   }
   ...
   protected TextureRegion getImage() {
      return Images.combatEffectStingProjectile;
   }
