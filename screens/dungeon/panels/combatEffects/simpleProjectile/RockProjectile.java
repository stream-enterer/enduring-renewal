...
public class RockProjectile extends SimpleAbstractProjectile {
   public RockProjectile(Ent source, Ent target, int damage) {
      super(source, target, damage, 0.29F);
   }
   ...
   protected TextureRegion getImage() {
      return Images.combatEffectRockProjectile;
   }
