...
public class FXBurn extends FXContainer {
   public FXBurn(Actor actor) {
      super(actor);
      this.loadShader(ShaderFolder.burn);
   ...
   public void draw(Batch batch, float parentAlpha) {
      ...
      this.program.setUniformf("u_time", com.tann.dice.Main.secs);
